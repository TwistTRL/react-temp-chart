...
var TempChartBundle = function (_PureComponent) {
  ...
  function TempChartBundle() {
    ...
    }, _this.updateVisbleYRange = function () {}, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(TempChartBundle, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          data = _props.data,
          isXAxisVisible = _props.isXAxisVisible;

      var filteredData = void 0;
      var plotWidth = width - LEFT_WIDTH - RIGHT_WIDTH;
      var plotHeight = isXAxisVisible ? height - TOP_HEIGHT - BOTTOM_HEIGHT : height;
      var minX = dtWindow[0];
      var maxX = dtWindow[1];
      var minY = 18;
      var maxY = 43;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          isXAxisVisible ? _react2.default.createElement(_DynamicDateYAxisTwoLevelPanel2.default, {
            minX: dtWindow[0],
            maxX: dtWindow[1],
            height: TOP_HEIGHT,
            width: LEFT_WIDTH
        ...
        _react2.default.createElement(
          _PlotContainers.PlotSubContainer,
          null,
          isXAxisVisible ? _react2.default.createElement(
            'div',
            null,
        ...
        _react2.default.createElement(
          _PlotContainers.PlotSubContainer,
          null,
          _react2.default.createElement(_TempChartLeftPanel2.default, {
            panelWidth: LEFT_WIDTH,
            panelHeight: plotHeight
          }),
          _react2.default.createElement(
            'div',
            { style: styles.yAxisWrappingDiv },
        ...
        _react2.default.createElement(
          _PlotContainers.PlotSubContainer,
          null,
          _react2.default.createElement(_TempChart2.default, {
            width: plotWidth,
            height: plotHeight,
            minX: dtWindow[0],
            maxX: dtWindow[1],
